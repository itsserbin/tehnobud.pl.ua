...
class CreateBuildingRequest extends FormRequest {
    ...
    /**
     * @return \App\Services\Dto\Building\CreateBuildingDto
     * @throws \Exception
     */
    public function getDto(): CreateBuildingDto
    {
        return new CreateBuildingDto(
            ...
            DateRange::create(
                $this->get('started_at') ? new DateTimeImmutable(
                    $this->get('started_at')
                ) : null,
                $this->get('ended_at') ? new DateTimeImmutable(
                    $this->get('ended_at')
                ) : null
            ),
            $this->file('main_photo')
        );
    }
